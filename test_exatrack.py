...
'''
Analyse tracks from bactrial motion
'''
...
params = np.array([[np.log(1), np.log(1), np.log(0.1), np.log(0.02), 0],
                   [np.log(1), np.log(0.1), np.log(1), np.log(0.3), 1],
                   [np.log(1), np.log(3), np.log(0.1), np.log(0.01), 0]])
nb_states = len(params)

initial_params = np.array([[np.log(100)]]*nb_states, dtype='float64')
...
params = np.array([[np.log(0.01), np.log(0.01), np.log(0.0002), np.log(1), np.log(1), 1],
                   [np.log(0.1), np.log(0.1), np.log(0.001), np.log(1), np.log(1), 0]])
nb_states = len(params)
